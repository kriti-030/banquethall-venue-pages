...
const reviews = [
  ...
  },
  {
    ...
    "eventDate": "Not available from source",
    "pax": "Not available from source",
    "review": "Our experience did not match the promises made during booking. Communication from one senior sales contact felt aggressive and unsettling, billing queries came up at awkward moments during rituals, and meal service ran late on more than one function. We spent much of the wedding week managing problems instead of enjoying it."
  }
];
...
export default GoldfinchHotelFaridabad;
